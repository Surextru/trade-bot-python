...
class Portfolio():
    ...
    def add_positions(self, positions: List[dict]) -> dict:
        ...
        if isinstance(positions, list):
            ...
            raise TypeError("Positions must be a list o f dictionaries.")
    ...
    def remove_position(self, symbol: str) -> Tuple[bool, str]:
        ...
        if symbol in self.positions:
            ...
            return (False, "{Symbol} was not removed.".format(symbol=symbol))
        

    def total_allocation(self):
        pass

    def risck_exposure(self):
        pass
